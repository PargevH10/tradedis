<!-- Order Modal -->
<div class="modal fade register-modal" id="orderModal" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="container_fluid">
                        <section id="order">
                            <div class="order_container">
                                ...
                                <p class="order_text">
                                    {{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
